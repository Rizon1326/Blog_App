...
urlpatterns = [
   ...
   path('post/comment_post/', api_views.PostCommentAPIView.as_view()),
   path('post/bookmark_post/', api_views.BookmarkPostAPIView.as_view()),
   ...
   path('author/dashboard/post-details/<user_id>/<post_id>/', api_views.DashboardPostEditAPIView.as_view()),
